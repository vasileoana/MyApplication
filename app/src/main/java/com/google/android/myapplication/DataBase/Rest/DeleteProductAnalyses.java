...
public class DeleteProductAnalyses extends AsyncTask<Integer, Void, Void>

{
    ...
    protected Void doInBackground(Integer... ints) {
        ...
        try {
            ...
            String urlString;
            urlString = "https://teme-vasileoana22.c9users.io/ProductAnalyses/" + id;
            //URL url = new URL(urlString);
            ...
            ProductAnalysisMethods productAnalysis = new ProductAnalysisMethods();
            productAnalysis.delete(id);
        } catch (IOException e) {
            e.printStackTrace();

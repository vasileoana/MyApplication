...
public class IngredientAnalysisMethods {
    ...
    {
        return "CREATE TABLE IF NOT EXISTS "+ IngredientAnalysis.TABLE+ " ( "+ IngredientAnalysis.label_idAnalysis+ " INTEGER PRIMARY KEY, "+ IngredientAnalysis.label_idIngredient+ " INTEGER, "
